...
export const PLANETS: PlanetDef[] = [
  ...
  { name: 'Aurelia', orbit: 350, angle0: 5.1, speed: 0.011, size: 18, type: 'rocky',
    color: 0xd8b24a, tags: ['tourism'], primary: 'tourism' },
  { name: 'Bronce', orbit: 415, angle0: 2.4, speed: 0.0095, size: 19, type: 'rocky',
    color: 0x9c7b50, tags: ['ore', 'minerals'], primary: 'ore',
    moons: [{ name: 'Slag', dist: 38, size: 6, speed: 1.0, angle0: 1, resource: 'ore' }] },
  { name: 'Halcyon', orbit: 500, angle0: 0.9, speed: 0.0080, size: 40, type: 'gas',
  ...
  { name: 'Numa', orbit: 585, angle0: 4.2, speed: 0.0068, size: 18, type: 'rocky',
    color: 0x7fb0c8, tags: ['crystal'], primary: 'crystal' },
  { name: 'Sylphid', orbit: 650, angle0: 1.1, speed: 0.0060, size: 21, type: 'rocky',
    color: 0x6fae72, tags: ['animals', 'plants'], primary: 'animals',
    moons: [{ name: 'Fen', dist: 40, size: 6, speed: 0.9, angle0: 2, resource: 'underwater' }] },
  { name: 'Maru', orbit: 715, angle0: 5.8, speed: 0.0053, size: 20, type: 'rocky',
    color: 0x4790a0, tags: ['underwater', 'animals'], primary: 'underwater' },
  { name: 'Castellan', orbit: 805, angle0: 2.9, speed: 0.0045, size: 46, type: 'gas',
  ...
  { name: 'Ophir', orbit: 880, angle0: 0.2, speed: 0.0039, size: 17, type: 'rocky',
    color: 0xc89a5a, tags: ['minerals'], primary: 'minerals' },
  { name: 'Drift', orbit: 945, angle0: 3.3, speed: 0.0034, size: 18, type: 'rocky',
    color: 0x8a8f99, tags: ['ore'], primary: 'ore' },
  { name: 'Wisp', orbit: 1030, angle0: 1.5, speed: 0.0029, size: 38, type: 'gas',
  ...
  { name: 'Solace', orbit: 1100, angle0: 4.9, speed: 0.0025, size: 20, type: 'rocky',
    color: 0xd6a98a, tags: ['tourism', 'underwater'], primary: 'tourism' },
  { name: 'Erebus', orbit: 1170, angle0: 2.0, speed: 0.0021, size: 19, type: 'rocky',
